...
# ===== SEGURANÇA =====
# Leia a documentação: https://docs.djangoproject.com/en/5.2/topics/security/
...
# Mode de desenvolvimento (False em produção!)
DEBUG = config('DEBUG', default=True, cast=bool)

# Hosts permitidos (lista de domínios aceitos)
